...
func ExpvarHandler(ctx *rawfasthttp.RequestCtx) {
	...
	if err != nil {
		...
		ctx.SetStatusCode(rawfasthttp.StatusBadRequest)
		return
	}
...
func getExpvarRegexp(ctx *rawfasthttp.RequestCtx) (*regexp.Regexp, error) {
